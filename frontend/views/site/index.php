                ...
                <div class="owl-carousel owl-theme slide" id="featured">
                    <div class="item">
                        <article class="featured">
                            ...
                            <figure>
                                <img src="/statics/images/news/img04.jpg" alt="Sample Article">
                            </figure>
                            <div class="details">
                    ...
                    <div class="item">
                        <article class="featured">
                            <div class="overlay"></div>
                            <figure>
                                <img src="/statics/images/news/img14.jpg" alt="Sample Article">
                            </figure>
                            <div class="details">
                    ...
                    <div class="item">
                        <article class="featured">
                            <div class="overlay"></div>
                            <figure>
                                <img src="/statics/images/news/img13.jpg" alt="Sample Article">
                            </figure>
                            <div class="details">
                    ...
                    <div class="item">
                        <article class="featured">
                            <div class="overlay"></div>
                            <figure>
                                <img src="/statics/images/news/img05.jpg" alt="Sample Article">
                            </figure>
                            <div class="details">
                        ...
                        <div class="row">
                            <article class="article col-md-12">
                                <div class="inner">
                                    <figure>
                                        <a href="single.html">
                                            <img src="/statics/images/news/img10.jpg" alt="Sample Article">
                                        </a>
                                    </figure>
                                    <div class="padding">
                                        <div class="detail">
                            ...
                            <article class="article col-md-12">
                                <div class="inner">
                                    <figure>
                                        <a href="single.html">
                                            <img src="/statics/images/news/img06.jpg" alt="Sample Article">
                                        </a>
                                    </figure>
                                    <div class="padding">
                                        <div class="detail">
                        ...
                        <div class="row">
                            ...
                            <article class="article col-md-12">
                                <div class="inner">
                                    <figure>
                                        <a href="single.html">
                                            <img src="/statics/images/news/img07.jpg" alt="Sample Article">
                                        </a>
                                    </figure>
                                    <div class="padding">
                                        <div class="detail">
                        ...
                        <div class="body-col vertical-slider" data-max="4" data-nav="#hot-news-nav" data-item="article">
                            <article class="article-mini">
                                <div class="inner">
                                    <figure>
                                        <a href="single.html">
                                            <img src="/statics/images/news/img09.jpg" alt="Sample Article">
                                        </a>
                                    </figure>
                                    <div class="padding">
                            ...
                            <article class="article-mini">
                                <div class="inner">
                                    <figure>
                                        <a href="single.html">
                                            <img src="/statics/images/news/img01.jpg" alt="Sample Article">
                                        </a>
                                    </figure>
                                    <div class="padding">
                                        <h1><a href="single.html">Duis aute irure dolor in reprehenderit in voluptate velit</a></h1>
                            ...
                            <article class="article-mini">
                                <div class="inner">
                                    <figure>
                                        <a href="single.html">
                                            <img src="/statics/images/news/img02.jpg" alt="Sample Article">
                                        </a>
                                    </figure>
                                    <div class="padding">
                            ...
                            <article class="article-mini">
                                <div class="inner">
                                    <figure>
                                        <a href="single.html">
                                            <img src="/statics/images/news/img08.jpg" alt="Sample Article">
                                        </a>
                                    </figure>
                                    <div class="padding">
                ...
                <div class="row">
                    <article class="col-md-12 article-list">
                        <div class="inner">
                            <figure>
                                <a href="single.html">
                                    <img src="/statics/images/news/img11.jpg" alt="Sample Article">
                                </a>
                            </figure>
                            <div class="details">
                                <div class="detail">
                    ...
                    <article class="col-md-12 article-list">
                        <div class="inner">
                            <figure>
                                <a href="single.html">
                                    <img src="/statics/images/news/img03.jpg" alt="Sample Article">
                                </a>
                            </figure>
                            <div class="details">
                                <div class="detail">
                    ...
                    <div class="aside-body">
                        <div class="featured-author">
                            <div class="featured-author-inner">
                                <div class="featured-author-cover" style="background-image: url('/statics/images/news/img15.jpg');">
                                    <div class="badges">
                                        <div class="badge-item"><i class="ion-star"></i> Featured</div>
                                    </div>
                                    <div class="featured-author-center">
                                        <figure class="featured-author-picture">
                                            <img src="/statics/images/img01.jpg" alt="Sample Article">
                                        </figure>
                                    ...
                                    <div class="block">
                                        ...
                                        <div class="block-body">
                                            <ul class="item-list-round" data-magnific="gallery">
                                                <li><a href="/statics/images/news/img06.jpg" style="background-image: url('/statics/images/news/img06.jpg');"></a></li>
                                                <li><a href="/statics/images/news/img07.jpg" style="background-image: url('/statics/images/news/img07.jpg');"></a></li>
                                                <li><a href="/statics/images/news/img08.jpg" style="background-image: url('/statics/images/news/img08.jpg');"></a></li>
                                                <li><a href="/statics/images/news/img09.jpg" style="background-image: url('/statics/images/news/img09.jpg');"></a></li>
                                                <li><a href="/statics/images/news/img10.jpg" style="background-image: url('/statics/images/news/img10.jpg');"></a></li>
                                                <li><a href="/statics/images/news/img11.jpg" style="background-image: url('/statics/images/news/img11.jpg');"></a></li>
                                                <li><a href="/statics/images/news/img12.jpg" style="background-image: url('/statics/images/news/img12.jpg');"><div class="more">+2</div></a></li>
                                                <li class="hidden"><a href="/statics/images/news/img13.jpg" style="background-image: url('/statics/images/news/img13.jpg');"></a></li>
                                                <li class="hidden"><a href="/statics/images/news/img14.jpg" style="background-image: url('/statics/images/news/img14.jpg');"></a></li>
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <div class="tab-pane active" id="recomended">
                            <article class="article-fw">
                                <div class="inner">
                                    <figure>
                                        <a href="single.html">
                                            <img src="/statics/images/news/img16.jpg" alt="Sample Article">
                                        </a>
                                    </figure>
                                    <div class="details">
                                        <div class="detail">
                        ...
                        <div class="tab-pane comments" id="comments">
                            <div class="comment-list sm">
                                <div class="item">
                                    <div class="user">
                                        <figure>
                                            <img src="/statics/images/img01.jpg" alt="User Picture">
                                        </figure>
                                        <div class="details">
        ...
        <div class="owl-carousel owl-theme carousel-1">
            ...
            <article class="article">
                <div class="inner">
                    <figure>
                        <a href="single.html">
                            <img src="/statics/images/news/img15.jpg" alt="Sample Article">
                        </a>
                    </figure>
                    <div class="padding">
                        <div class="detail">
