        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-12">
                    <div class="brand">
                        <a href="index.html">
                            <img src="/statics/images/logo.png" alt="Magz Logo">
                        </a>
                    </div>
                </div>
                ...
                <div class="block">
                    ...
                    <div class="block-body">
                        <figure class="foot-logo">
                            <img src="/statics/images/logo-light.png" class="img-responsive" alt="Logo">
                        </figure>
                    ...
                    <div class="block-body">
                        <article class="article-mini">
                            <div class="inner">
                                <figure>
                                    <a href="single.html">
                                        <img src="/statics/images/news/img12.jpg" alt="Sample Article">
                                    </a>
                                </figure>
                                <div class="padding">
